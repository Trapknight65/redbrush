    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-canvas-white max-w-2xl mx-auto mb-8 sm:mb-10 px-4">
            We craft stunning digital experiences that drive results. From web development to branding, we've got you covered.
          </p>

          <div className="flex gap-3 sm:gap-4 items-center justify-center flex-wrap px-4">
